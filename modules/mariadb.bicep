...
module cacheSecret 'keyvaultsecret.bicep' = {
  ...
  params: {
    ...
    secretValue: 'mysql+pymysql://${administratorLogin}%40${mariaServerName}.mariadb.database.azure.com:${administratorLoginPassword}@${mariaServerName}.mariadb.database.azure.com/ctfd?ssl_ca=/opt/certificates/DigiCertGlobalRootG2.crt.pem'
  }
}
